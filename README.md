...
- [cursor-agent-service](https://github.com/AxLabs/cursor-agent-service): Run the Cursor CLI agent worker as a native OS service on Linux (systemd) or macOS (launchd) so you can deploy and run your own self-hosted agents.
