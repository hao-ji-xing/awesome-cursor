...
- [BGPT MCP](https://github.com/connerlambden/bgpt-mcp): Search scientific papers and retrieve structured experimental data via MCP. Remote server — no install needed. ![GitHub Repo stars](https://img.shields.io/github/stars/connerlambden/bgpt-mcp)
