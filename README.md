...
- [cursor-lint](https://github.com/nedcodes-ok/cursor-lint): A linter for .cursorrules and .mdc files — catches broken rules before they silently fail. Lint, fix, generate, and verify your Cursor rules from the CLI. ![GitHub Repo stars](https://img.shields.io/github/stars/nedcodes-ok/cursor-lint)
- [cursorrules-collection](https://github.com/nedcodes-ok/cursorrules-collection): A curated collection of .cursorrules and .mdc files for popular frameworks and stacks. ![GitHub Repo stars](https://img.shields.io/github/stars/nedcodes-ok/cursorrules-collection)
...
- [zambo](https://github.com/zambodotdev/zambo-mcp): Give your AI hands. One URL. Type a job. Get a receipt. 120 native MCP tools across 17 products behind one zero-auth remote endpoint — free 20 calls/tool/day, no account, one-click install for Cursor. ![GitHub Repo stars](https://img.shields.io/github/stars/zambodotdev/zambo-mcp)
